...
for {set i 0} {$i < 20} {incr i} {
    ...
    if {$p != ""} {
        ...
        editPin -pin $p -assign [list $px $HEIGHT] -layer ${PIN_LAYER_4} -width 0.2 -depth 0.2 -fixedPin
    }
}
...
for {set i 0} {$i < 20} {incr i} {
    ...
    if {$p != ""} {
        set px [expr {$start_x + $i * $pitch}]
        editPin -pin $p -assign [list $px 0.0] -layer ${PIN_LAYER_4} -width 0.2 -depth 0.2 -fixedPin
    }
}
