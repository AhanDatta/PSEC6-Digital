...
set DESIGN_NAME "ref_clk_sel_decoder"
...
# Netlist
set init_verilog /home/designs/Synthesis/ref_clk_sel/results/ref_clk_sel_synth.v
...
editChangeStatus -net {VDD VSS} -to FIXED
